<template>
  <div class="form-container">
    <h2>Edit Vaccine Schedule</h2>

    <form class="form-card" @submit.prevent="update">
      ...
      <div class="form-group">
        ...
        <input type="number" v-model="doseNo" min="1" />
      </div>

      <!-- Gap -->
      <div class="form-group">
        <label>Gap Days</label>
        <input type="number" v-model="gapDays" min="0" />
      </div>
...
async function loadData() {
  ...
  vaccineId.value = schedule.vaccineId
  vaccineSearch.value = schedule.vaccineName
  doseNo.value = schedule.doseNo
  gapDays.value = schedule.gapDays
  doseType.value = schedule.doseType
  isRecurring.value = schedule.isRecurring
  maxOccurrences.value = schedule.maxOccurrences
}
